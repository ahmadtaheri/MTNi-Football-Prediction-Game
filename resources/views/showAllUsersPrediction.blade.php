    ...
    <div class="row">
        ...
        <main class="col-12">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">{{$match->teamA}}</th>
                                        <th scope="col">{{$match->teamB}}</th>
                                    ...
                                    @foreach($match->users as $user)
                                        <tr>
                                            ...
                                            <td>{{$user->pivot->teamA_Score_prediction}} </td>
                                            <td>{{$user->pivot->teamB_Score_prediction}} </td>
                                            <td>{{$user->pivot->match_point}} </td>
            ...
            <div class="row mt-4">
                <div class="col-12 col-xl-8 mb-4 mb-lg-0">
                    <div class="card">
                        <h5 class="card-header alert-danger">unpredicted users</h5>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                                    ...
                                    @foreach($unpredictedUsers as $key => $id)
                                        <tr>
                                            <th scope="row">{{$i+=1}}</th>
                                            <td>{{App\Models\User::find($id)->firstName}} {{App\Models\User::find($id)->lastName}} </td>
